...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT * FROM public.ogrenci where sinif = '10A' and cinsiyet = 'K'";

    @Query(value = QUESTION_4, nativeQuery = true)
    List<Ogrenci> find10AGirls();

    //Öğrenci numarası 5 ile 10 arasında olan Kız öğrencileri listeleyiniz.
    String QUESTION_5 = "SELECT * FROM public.ogrenci where ogrno < 10 and ogrno > 5 and cinsiyet = 'K'";
    ...
    String QUESTION_7 = "SELECT * FROM public.ogrenci where sinif = '10A' and cinsiyet = 'K' ";
